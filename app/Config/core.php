...
define('SITE_NAME','cofetch');
define("BASE_URL",FULL_BASE_URL.preg_replace("/^(.*)app(.*)/i","$1",$_SERVER['SCRIPT_NAME']));
define("DATE_FORMAT","m/d/Y");
define("DATE_FORMATS","Y-m-d");
define("ADMIN_EMAIL","info@cofetch.com");
define("ADMIN_NAME","cofetch");
define("ADMIN_ID","1");
define("RECORDS_PER_PAGE","100");
define("API_AUTH_KEY","123");
define("NEXMO_KEY","ed7d39e7");
define("NEXMO_SECRET","7fb878ec");
